import SidebarNavigation from "./navigation/static-aside/SidebarNavigation.svelte";
import DataUserGeneral from "./navigation/static-aside/DataUserGeneral.svelte";
import ItemSidebarNavigation from "./navigation/static-aside/ItemSidebarNavigation.svelte";
import SidebarContainerBodyNavigation from "./navigation/static-aside/SidebarContainerBodyNavigation.svelte";
import SubItemsSidebarNavigation from "./navigation/static-aside/SubItemsSidebarNavigation.svelte";
