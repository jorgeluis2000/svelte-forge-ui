<script lang="ts">
	...
	import PersonalSelectBox from './../../select/PersonalSelectBox.svelte';
	...
	export const onInput: (e: Event & { currentTarget: EventTarget & HTMLInputElement }) => void = (
		event
	) => {
		...
		<section class="container-select" transition:slide>
			<div class="realtive">
				...
				<div class="content-list-items">
					<PersonalSelectBox listShow={listSearch} bind:selected={valueInput} />
				</div>
			</div>
		</section>
	{/if}
